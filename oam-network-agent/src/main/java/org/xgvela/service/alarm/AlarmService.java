package org.xgvela.service.alarm;
...
public class AlarmService extends AlarmReportServiceGrpc.AlarmReportServiceImplBase {
    ...
    @Override
    public void alarmReport(org.xgvela.oam.alarm.AlarmReq request, io.grpc.stub.StreamObserver<org.xgvela.oam.alarm.AlarmRsp> responseObserver) {
