...
#when you download oam-network-nfregister-1.0-SNAPSHOT.jar from google-driver
cd ~/oam/cloud-native-OAM/oam-network-nfregister/
cp oam-network-nfregister-1.0-SNAPSHOT.jar ci/linux/app.jar
cd ci/linux
